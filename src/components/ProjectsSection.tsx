            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <GlassCard className="flex flex-col group relative">
                    ...
                    <div className="space-y-2 mb-6">
                        ...
                        <FeatureItem icon={Sparkles} text="Integrated custom LLM Assistant via Gemini 2.5 API." />
                    ...
                    <div className="flex flex-col gap-4 mt-auto pt-4 border-t border-slate-800">
                        <div className="flex flex-wrap gap-2">
                            <Badge>React</Badge> <Badge>Tailwind</Badge> <Badge>Gemini API</Badge>
                        </div>
                        <button className="flex items-center gap-2 text-sm text-cyan-400 hover:text-cyan-300 transition-colors font-medium self-start">
                ...
                <GlassCard className="flex flex-col group relative">
                    ...
                    <div className="space-y-2 mb-6">
                        ...
                        <FeatureItem icon={MapPin} text="FastAPI REST API with PostgreSQL + PostGIS for geo-queries." />
                        <FeatureItem icon={Cloud} text="Firebase (Auth/Push) & AWS S3 integration." />
                    </div>

                    <div className="flex flex-col gap-4 mt-auto pt-4 border-t border-slate-800">
                        <div className="flex flex-wrap gap-2">
                            <Badge>Flutter</Badge> <Badge>FastAPI</Badge> <Badge>PostGIS</Badge>
                        </div>
                        <button className="flex items-center gap-2 text-sm text-cyan-400 hover:text-cyan-300 transition-colors font-medium self-start">
                            See more <ExternalLink className="w-4 h-4" />
                        </button>
                ...
                <GlassCard className="flex flex-col group relative">
                    <div className="h-32 bg-gradient-to-r from-slate-800/80 to-purple-900/30 rounded-xl mb-6 flex items-center justify-center border border-slate-700/50 group-hover:border-purple-500/50 transition-colors">
                        <Users className="w-12 h-12 text-purple-300 drop-shadow-[0_0_10px_rgba(216,180,254,0.5)]" />
                    </div>
